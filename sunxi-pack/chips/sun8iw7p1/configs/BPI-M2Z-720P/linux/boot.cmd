...
setenv bootargs "board=bpi-m2z root=${rootdev} rootwait rootfstype=${rootfstype} ${consoleargs} hdmi.audio=EDID:0 disp.screen0_output_mode=${disp_mode} panic=10 consoleblank=0 loglevel=${verbosity} ubootpart=${partuuid} ubootsource=${devtype} fsck.mode=force fsck.repair=yes ${extraargs} ${extraboardargs}"
